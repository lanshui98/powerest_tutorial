...
The following code uses the pre-calculated [power estimation results](https://github.com/lanshui98/powerest_tutorial/tree/master/data/merge_long.csv) of bootstraping resampled replicates ranging from 1 to 10.
